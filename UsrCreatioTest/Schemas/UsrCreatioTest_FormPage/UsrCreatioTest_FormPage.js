define("UsrCreatioTest_FormPage", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(MaxPriceButton_caption)#",
					"color": "accent",
					"disabled": false,
					"size": "large",
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var colorsObjectObject = await request.$context.PDS_UsrColorsLookup_0ef5k2u;
					var colorId = "";
					if (colorsObjectObject) {
						colorId = colorsObjectObject.value;
					}
